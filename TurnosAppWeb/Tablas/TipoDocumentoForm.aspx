<%@ Page Title="" Language="C#" MasterPageFile="~/TunosWeb.Master" AutoEventWireup="true" CodeBehind="TipoDocumentoForm.aspx.cs" Inherits="TurnosAppWeb.Tablas.TipoDocumentoForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row col-md-6 justify-content-center">
        <% if (btnModificar.Visible == false)
            {  %>
        <h1 class="align-self-center">Registrar nuevo Tipo Documento</h1>
        <% }
            else
            {  %>
        <h1 class="align-self-center">Modificar Tipo Documento</h1>
        <% } %>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="txtDescripcion" class="form-label">Nombre Tipo Documento</label>
